    ...
    extend: {
      colors: {
        ...
        pos: {
          ...
          "sidebar-foot": "hsl(var(--pos-sidebar-foot))",
          primary: "hsl(var(--pos-primary))",
          dark: "hsl(var(--pos-dark))",
          muted: "hsl(var(--pos-muted))",
          subtle: "hsl(var(--pos-subtle))",
          border: "hsl(var(--pos-border))",
          "green-soft": "hsl(var(--pos-green-soft))",
          "blue-soft": "hsl(var(--pos-blue-soft))",
          "red-soft": "hsl(var(--pos-red-soft))",
          red: "hsl(var(--pos-red))",
